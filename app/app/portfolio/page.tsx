        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
          ...
          <div className="flex gap-2">
            <button
              ...
              className="h-[32px] px-4 flex items-center text-body-sm font-medium rounded-md bg-accent text-text-inverse hover:bg-accent-hover transition-fast"
            >
              Deposit
            </button>
            <button
            ...
            <button
              className="h-[32px] px-4 flex items-center text-body-sm font-medium border border-border rounded-md text-text-primary opacity-50 cursor-not-allowed transition-fast"
              title="Coming soon"
              disabled
            >
              Transfer
