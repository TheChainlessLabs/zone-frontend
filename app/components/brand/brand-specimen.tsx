  ...
  return (
    <div className="mx-auto flex w-full max-w-7xl flex-col gap-6 px-4 py-8 md:px-8" data-testid={`brand-specimen-${direction}`}>
      ...
      <div className="grid gap-6 xl:grid-cols-[1.15fr_0.85fr]">
        <Fixture title="Navbar mockup"><div data-testid="fixture-navbar" className="flex items-center justify-between rounded-xl border border-[var(--border)] bg-[var(--card)] px-4 py-3"><span data-brand-label className="font-mono text-[11px] uppercase tracking-[0.18em]">Omega desk</span><div className="flex gap-2"><Chip active>Trade</Chip><Chip>Batches</Chip><Chip>Account</Chip></div><span data-brand-action-zone className="font-mono text-[10px] uppercase tracking-[0.18em]"><span>desk live</span><span className="h-2.5 w-2.5 rounded-full border border-[var(--border)] bg-transparent" /></span></div></Fixture>
