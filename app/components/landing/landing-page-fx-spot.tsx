  ...
  return (
    <div className="lp-content relative select-none bg-black text-white">
      ...
      <div className="relative z-10 flex flex-col pt-[96px] min-[1775px]:flex-row">
        ...
        <div
          ref={railRef}
          className="w-full space-y-8 px-6 pb-[60vh] pt-48 sm:max-[1774px]:px-10 min-[1775px]:ml-auto min-[1775px]:w-[calc(100%-719px)] min-[1775px]:space-y-0 min-[1775px]:pl-6 min-[1775px]:pr-16 min-[1775px]:pb-[20vh] min-[1775px]:pt-0 min-[1775px]:-mt-[6vh]"
        >
