...
export function PortfolioDrilldownSheet({
    ...
    return (
      <Sheet open={open} onOpenChange={onOpenChange}>
        <SheetContent
          ...
          className="border-l border-[var(--border)] bg-[var(--card)] p-0"
        >
  ...
  return (
    <Drawer open={open} onOpenChange={onOpenChange}>
      <DrawerContent
        aria-label={ariaLabel}
        className="h-[100dvh] max-h-[100dvh] rounded-t-[var(--radius-xl)] bg-[var(--card)] pb-[max(env(safe-area-inset-bottom),1rem)]"
      >
