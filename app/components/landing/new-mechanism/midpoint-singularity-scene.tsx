...
import { ReducedMotionStory } from "./reduced-motion-story";
import {
  clamp,
  easeInOut,
  getSceneState,
...
export function MidpointScene({ state, sceneRef }: MidpointSceneProps) {
  ...
  return (
    ...
    >
      ...
      {/* event horizon halo */}
      <circle cx={CX} cy={CY} r={horizon + 30} fill="url(#nm-halo)" />
      <circle
        cx={CX}
        cy={CY}
        r={horizon}
      ...
      {/* radiation noise out (late phase 2) */}
      {noise > 0
      ...
      {/* core */}
      <circle cx={CX} cy={CY} r={coreR + 14} fill="url(#nm-core)" opacity="0.5" />
